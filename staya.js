...
describe('Напиши автотесты для формы логина и пароля на Staya', function () {
   it('Необходимо завести себе аккаунт с помощью логина и пароля', function () {
        ...
        cy.get("#__layout > div > main > div > div > div > section > div > form > input:nth-child(2)").type('342089');
